...
class IndexController extends AbstractController
{
    ...
    public function show($id, EntityManagerInterface $em): Response
    {
        ...
        // Si l'employé n'existe pas, afficher une page 404
        if (!$employe) {
            throw $this->createNotFoundException('Employé non trouvé');
        }
    
        // Retourner la vue Twig avec les données de l'employé
        return $this->render('employe/show.html.twig', [
            'employe' => $employe, // Passer l'objet employé à la vue
        ]);
    }
    ...
    public function edit(Request $request, $id, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('employe/edit.html.twig', [
            ...
            'employe' => $employe,  // Passer l'employé à Twig
        ]);
    }
