...
public function pointagePage(): Response
{
    ...
    #[Route('/rapport-evenements', name: 'rapport_evenements', methods: ['GET'])]
public function generateEventReport(EventRepository $eventRepository): Response
{
    ...
    $sheet->setCellValue('E1', 'Durée (en heures)');
    ...
    foreach ($events as $event) {
        ...
        // Calculer la durée en heures si les dates de début et de fin sont disponibles
