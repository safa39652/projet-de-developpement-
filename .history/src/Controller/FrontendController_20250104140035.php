...
class FrontendController extends AbstractController
{
    ...
    public function __construct(HttpClientInterface $httpClient, EmployeRepository $employeRepository, RequestStack $requestStack)
    {
    ...
    public function checkEmployee(Request $request): JsonResponse
    {
        ...
        if ($statusCode === 200) {
            ...
            if (isset($apiResponse['employee'])) {
                ...
                $this->session->set('employee', $apiResponse['employee']);
                $this->session->set('capturedImageUrl', $apiResponse['capturedImageUrl']);
            }
