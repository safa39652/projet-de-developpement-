...
<body>
   ...
   <div id="admin-icon-container">
    ...
    const image = captureImage(); // fonction pour capturer l'image
    console.log(image); // Vérifiez si l'image est bien capturée ici
    
    // Envoyer l'image si elle est valide
    if (image) {
        fetch('/api/check-employee', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ image: image }) // envoyer l'image capturée
        })
