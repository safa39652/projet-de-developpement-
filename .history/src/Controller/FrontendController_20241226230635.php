...
class FrontendController extends AbstractController
{
    ...
    public function index(): Response
    {
     ...
     // Injection du gestionnaire d'entité via le constructeur
        public function __construct2(EntityManagerInterface $entityManager)
        {
            ...
            if ($statusCode === 200) {
                ...
                if (isset($apiResponse['employee'])) {
                    ...
                    if ($employe) {
                        ...
                        // Enregistrer le chemin de l'image ou le nom du fichier dans l'entité Employe
                        $employe->setPhoto($fileName);  // Assurez-vous d'avoir un champ "photo" dans votre entité Employe
