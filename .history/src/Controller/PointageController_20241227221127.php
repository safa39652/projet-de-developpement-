    ...
    public function rapportPointages(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($jour) {
            ...
            if (isset($jourDeLaSemaine[strtolower($jour)])) {
                ...
                throw new \InvalidArgumentException('Le jour spécifié est invalide. Vérifiez que le paramètre "jour" est bien l’un des suivants : Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday.');
            }
        }
