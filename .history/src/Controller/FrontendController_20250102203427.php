...
class FrontendController extends AbstractController
{
    ...
    public function checkEmployee(Request $request): JsonResponse
    {
        try {
            ...
            // Définir le chemin où l'image sera stockée temporairement
            ...
            if ($statusCode !== 200) {
                ...
                return new JsonResponse(['message' => 'Erreur lors de la reconnaissance', 'details' => $errorMessage], $statusCode);
            }
    
            $data = $response->toArray();
    
            // Ajouter l'URL complète de l'image au retour JSON
            $data['employee']['capturedImageUrl'] = $request->getSchemeAndHttpHost() . '/uploads/' . $fileName;
