        ...
        try {
            ...
            if ($response->getStatusCode() === 200) {
                ...
                if (isset($apiResponse['employee'])) {
                    ...
                    $employe = $this->entityManager->getRepository(Employe::class)->findOneBy(['nom' => $employeeName]);
                    ...
                    if ($employe) {
                        ...
                        $emotion = new Emotion();
                        $emotion->setEmploye($employeeName);
                        $emotion->setEmotion($apiResponse['emotion'] ?? 'Inconnue');
                        ...
                        $apiResponse['message'] = 'Enregistrement réussi';
                    ...
                    return new JsonResponse(['message' => 'Aucun employé reconnu'], 404);
                }
            } else {
                return new JsonResponse(['message' => 'Erreur lors de la reconnaissance'], $response->getStatusCode());
            }
        } catch (\Exception $e) {
