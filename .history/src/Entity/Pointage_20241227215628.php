...
public function updateMoisAnneeHeureJour(): void
{
    ...
    // Utiliser strftime pour récupérer le jour en français
    $jourFrancais = strftime('%A', $this->heureEntree->getTimestamp());

    // Enregistrer le jour avec la première lettre en majuscule
    $this->jour = ucfirst($jourFrancais);
}
